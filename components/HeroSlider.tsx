...
export default function HeroSlider({ badge, badgeSub, title, subtitle, cta1, cta2 }: HeroSliderProps) {
  ...
  return (
    <section className="relative flex min-h-[calc(60vh-73px)] md:min-h-[calc(80vh-73px)] flex-col items-center justify-start sm:justify-center px-6 pt-6 pb-12 sm:pt-0 sm:pb-0 text-center overflow-hidden">
